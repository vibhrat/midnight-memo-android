      ...
      <div className="max-w-2xl mx-auto p-4 pb-20 relative z-10 py-[64px]">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-2">
            <button onClick={() => setShowImportDialog(true)} className="p-2 hover:bg-[#181818] rounded-lg">
        ...
        <div className="space-y-4">
          {lists.map(list => <Card key={list.id} className="cursor-pointer hover:bg-[#2A2A2A] transition-colors border-0 rounded-lg" style={{
        ...
        <ImportDialog isOpen={showImportDialog} onClose={() => setShowImportDialog(false)} type="list" />
      </div>
    </div>;
});
